...
exports.isValidTicTacToeMove = isValidTicTacToeMove;
exports.checkTicTacToeWinner = checkTicTacToeWinner;
exports.isBoardFull = isBoardFull;
exports.getBestTicTacToeMove = getBestTicTacToeMove;
function isValidTicTacToeMove(board, row, col) {
...
function getBestTicTacToeMove(board, symbol) {
